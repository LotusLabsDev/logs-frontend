...
const injectStyles = () => {
  ...
  el.id = id;
  el.textContent = `.gradual-blur{pointer-events:none;transition:opacity .3s ease-out}.gradual-blur>div{position:relative;width:100%;height:100%}.gradual-blur>div>div{position:absolute;inset:0}`;
